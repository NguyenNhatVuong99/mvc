...
+(function (e) {
            ...
            (this.visible = !1),
                ...
                (this.timepicker = {
                    ...
                    clockHolder: {
                        ...
                        buttonsHolder: { wrapper: e('<div class="mdtp__buttons">'), btnOk: e('<span class="mdtp__button ok">Ok</span>'), btnCancel: e('<span class="mdtp__button cancel">Cancel</span>') },
                    },
                });
            var n = s.timepicker;
            if (
                ...
                n.clockHolder.buttonsHolder.btnOk.click(function () {
                    ...
                    s.input.trigger(e.Event("timechanged", { time: t.time, value: t.value })).trigger("onchange"), s.hide();
                }),
    ...
    (d.prototype = {
        ...
        setup: function (t) {
            ...
            switch (
                (m.clock.wrapper.append(m.am).append(m.pm).append(m.clock.dot).append(m.clock.hours).append(m.clock.minutes).appendTo(m.wrapper),
                m.buttonsHolder.wrapper.append(m.buttonsHolder.btnCancel).append(m.buttonsHolder.btnOk).appendTo(m.wrapper),
        ...
        (e.fn.mdtimepicker.defaults = { timeFormat: "hh:mm:ss.000", format: "h:mm tt", theme: "blue", readOnly: !0, hourPadding: !1 });
})(jQuery);
