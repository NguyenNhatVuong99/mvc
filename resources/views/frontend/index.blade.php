...
@if(count($banners)>0)
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
                @foreach($banners as $key=>$banner)
                <div class="carousel-item {{(($key==0)? '1' : '')}}">
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    ...
                                                    <a title="Wishlist" href="#" onclick="addToCart({{ $product->slug }})" ><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                </div>
                                                <div class="product-action-2">
                                                    {{--  <button onclick="addToCart();">fjjshfhk</button>  --}}
                                                    <a  id="myLink" title="Thêm giỏ hàng"
                         data-slug="{{ $product->slug }}" onclick="addToCart(this);">Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="list-image overlay">
                                        ...
                                        <img src="{{$photo[0]}}" alt="{{$photo[0]}}">
                                        <a  id="myLink" title="Thêm giỏ hàng"
                                        data-slug="{{ $product->slug }}" onclick="addToCart(this);"><i class="fa fa-shopping-bag"></i></a>
