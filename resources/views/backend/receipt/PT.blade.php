         ...
         <div class="collapse panel-collapse show collapse-stock" id="PC">
            <div class="card">
               <div class="card-header">
                  ...
                  <div id="reportrange-PT" data-cat="PT" class="float-left datetimepicker datetime-PT" onapply="changeDateTimePT(e)" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 24%; margin-left:20px">
                     <i class="fa fa-calendar" style="color: #007DFF"></i>&nbsp;
                     <span id="date-PT"></span> <i class="fa fa-caret-down" style="color: #007DFF"></i>
                  </div>
                  <button class="btn btn-primary btn-sm float-right " data-toggle="modal" data-target="#modalCreatePC" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm phiếu thu</button>
                  <a class="btn btn-primary btn-sm float-right mr-2" href="{{route('admin.PC')}}"> Phiếu chi</a>
               </div>
               <div class="card-body">
                  <div class="table-responsive">
                     <input class="auto-numeric" type="hidden">
                     <table style="color: #333" class="table table-bordered display" id="table-PT"  width="100%" cellspacing="0">
                        <thead>
                           <tr>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Thêm phiếu thu</h5>
         ...
         <form id="form-store">
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <input   onkeyup="getNumber(this)"  required autofocus  class="form-control" id="total-PC" placeholder="">
               ...
               <div class="form-group">
                  ...
                  <select name="child_cat"  id='PC-select' data-size="5" data-actions-box="true" data-live-search="true" required class="form-control">
...
{{-- <script>
  ...
  <script>
    ...
    function getNumber(e){
        var number = converValueNumber('#total-PC');
