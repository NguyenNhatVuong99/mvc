            ...
            <div class="card">
               <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="m-0 font-weight-bold text-primary float-left">Bảng lương - {{ Session::get('branch')->name }}</h4>
                        <a href="{{ route('manager.salary.create') }}" class="btn btn-success"><i class="fas fa-plus"></i> Thêm bảng lương</a>
                   </div>
               </div>
               <div class="card-body">
                  <div class="table-responsive">
        ...
        function getData() {
            ...
            var table = $('#table').DataTable({
                ...
                ajax: {
                    ...
                    url: '{{  route("manager.salary.index")}}',
                },
                ...
                columns: [
                    ...
                    },
                    {
                        render: function(data,type,row) {
                            url ="{{route('manager.salary.show', '')}}"+"/"+row.slug;
                    ...
                    },
                    {
                        render: function(data,type,row) {
                            content='';
                                if(row.isPublic==0){
                                    content+='<h4><span class="badge badge-danger">Chưa công bố</span></h4>';
                                }
                                else{
                                    content+='<h4><span class="badge badge-success">Công bố</span></h4>';
                                }
                                if(row.isPay==0){
